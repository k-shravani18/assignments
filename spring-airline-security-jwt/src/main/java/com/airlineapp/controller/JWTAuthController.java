...
import com.airlineapp.service.JWTUserServiceImpl;
...
public class JWTAuthController {
    ...
    //this url will be authenticated
    ...
    //generate the token with the userdata recieved from db
